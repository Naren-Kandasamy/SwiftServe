// firebase_options.dart — generated for Web platform
// TODO: Replace placeholder values with real values from your Firebase Console.
// Go to: Firebase Console → Project Settings → Your apps → Web app → SDK setup and config.
...
class DefaultFirebaseOptions {
  ...
  // ─── Web ───────────────────────────────────────────────────────────────────
  // Replace every value here with what you see in Firebase Console → Web App Config
